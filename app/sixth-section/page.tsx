    ...
    return(
        ...
        <section className="bg-white md:py-70 py-20 my-5 mx-3  space-x-32 rounded-2xl flex "  >
            ...
            <div className="flex flex-col"><div>
                ...
                <Image src="/images/emotions/sign.png" alt="sign" className="items-center justify-center  mix-blend-multiply right-96" height={100} width={200} />
                <div className=" md:flex md:space-x-3 justify-center items-center">
