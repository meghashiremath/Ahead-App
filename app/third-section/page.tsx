                ...
                <div className="flex flex-row w-auto justify-between  " > 
                    ...
                    <div className="relative w-full max-w-full mt-20 md:pb-8">
                       ...
                       <div className="absolute top-5 left-44 -right-20 w-60 h-60 bg-white rounded-full   "></div>
                        ...
                        <Image src="/images/emotions/con.avif" alt="third" height={20} width={50} className="absolute -right-10 top-48  -rotate-45 mix-blend-multiply animate-pulse "/>
                        <Image src="/images/emotions/con.avif" alt="third" height={20} width={50} className="absolute -right-32 top-20  -rotate-45 mix-blend-multiply animate-pulse "/>
