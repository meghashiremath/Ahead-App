    ...
    return(
        ...
        <section className="bg-white md:py-70 py-20 my-5 mx-3  space-x-32 rounded-2xl flex "  >
            ...
            <div className="flex flex-col"><div>
                <p className="text-black text-base  md:px-20 pb-10">Wrong with self improvement & how we're fixing it.</p>
                <p className="text-6xl  space-y-5 font-extrabold md:px-20 pb-10 text-black bg-clip-text space-x-5 animate-blob" > Self-improvemt. Ugh..</p>
